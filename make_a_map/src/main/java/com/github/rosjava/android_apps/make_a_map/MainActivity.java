...
public class MainActivity extends RosAppActivity {
	...
	private PoseSubscriberLayer robotPose=null;
	private PathLayer robotPath=null;
...
//		robotPose = new PoseSubscriberLayer("/robot_pose");
//		robotPath= new PathLayer("/trajectory");
        mapView.onCreate(Lists.<Layer>newArrayList());
//		mapView.onCreate(Lists.<Layer>newArrayList(occupancyGridLayer,laserScanLayer,robotLayer,robotPose,robotPath));
...
//		String robotFrame="base_link";
		...
		mapView.addLayer(robotPose);
		mapView.addLayer(robotPath);
//		mapView.addLayer(viewControlLayer);
